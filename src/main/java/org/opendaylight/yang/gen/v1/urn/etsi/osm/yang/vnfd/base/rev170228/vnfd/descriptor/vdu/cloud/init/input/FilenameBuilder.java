...
/**
 * Class that builds {@link FilenameBuilder} instances. Overall design of the class is that of a
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of FilenameBuilder, as instances can be freely passed around without
...
public class FilenameBuilder implements Builder<Filename> {
    ...
    /**
      ...
      */
    public FilenameBuilder addAugmentation(Augmentation<Filename> augmentation) {
    ...
    private FilenameBuilder doAddAugmentation(Class<? extends Augmentation<Filename>> augmentationType, Augmentation<Filename> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class FilenameImpl
        extends AbstractAugmentable<Filename>
        implements Filename {
        ...
        public boolean equals(Object obj) {
            ...
            if (!Filename.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<Filename>>, Augmentation<Filename>> e : augmentations().entrySet()) {
