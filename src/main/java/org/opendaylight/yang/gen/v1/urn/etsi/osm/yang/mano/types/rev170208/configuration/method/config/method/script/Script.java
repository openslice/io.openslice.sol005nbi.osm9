 ...
 * <i>mano-types/configuration-method/config-method/script/script</i>
 * 
    ...
    Augmentable<Script>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.script.Script> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.script.Script.class;
    }
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.script.Script.ScriptType</code> <code>scriptType</code>, or <code>null</code> if not present
     */
