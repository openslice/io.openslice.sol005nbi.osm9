...
/**
 * Class that builds {@link InternalPortsBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     InternalPortsBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new InternalPortsBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of InternalPortsBuilder, as instances can be freely passed around without
...
public class InternalPortsBuilder implements Builder<InternalPorts> {
    ...
    public InternalPortsBuilder(InternalPorts base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<InternalPorts>>, Augmentation<InternalPorts>> aug =((AugmentationHolder<InternalPorts>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public InternalPortsBuilder setTotal(final Uint64 value) {
        this._total = value;
        return this;
    }
    ...
    /**
      ...
      */
    public InternalPortsBuilder addAugmentation(Augmentation<InternalPorts> augmentation) {
    ...
    private InternalPortsBuilder doAddAugmentation(Class<? extends Augmentation<InternalPorts>> augmentationType, Augmentation<InternalPorts> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class InternalPortsImpl
        extends AbstractAugmentable<InternalPorts>
        implements InternalPorts {
    
        private final String _label;
        private final Uint64 _total;
    
        InternalPortsImpl(InternalPortsBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!InternalPorts.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<InternalPorts>>, Augmentation<InternalPorts>> e : augmentations().entrySet()) {
