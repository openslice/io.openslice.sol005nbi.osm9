...
/**
 * Class that builds {@link NsConfigurationBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NsConfigurationBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NsConfigurationBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NsConfigurationBuilder, as instances can be freely passed around without
 ...
 *
 */
public class NsConfigurationBuilder implements Builder<NsConfiguration> {
    ...
    Map<Class<? extends Augmentation<NsConfiguration>>, Augmentation<NsConfiguration>> augmentation = Collections.emptyMap();

    public NsConfigurationBuilder() {
    }
    public NsConfigurationBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.VcaConfiguration arg) {
    ...
    public NsConfigurationBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.ConfigurationMethod arg) {
        this._configMethod = arg.getConfigMethod();
    }
    public NsConfigurationBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.VcaMetrics arg) {
        this._metrics = arg.getMetrics();
    }
    public NsConfigurationBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.VcaRelations arg) {
        this._relation = arg.getRelation();
    }

    public NsConfigurationBuilder(NsConfiguration base) {
        if (base instanceof AugmentationHolder) {
            @SuppressWarnings("unchecked")
            Map<Class<? extends Augmentation<NsConfiguration>>, Augmentation<NsConfiguration>> aug =((AugmentationHolder<NsConfiguration>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.VcaConfiguration, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.ConfigurationMethod, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.VcaRelations, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.VcaMetrics]");
    }
    ...
    public <E$$ extends Augmentation<NsConfiguration>> E$$ augmentation(Class<E$$> augmentationType) {
        return (E$$) augmentation.get(Objects.requireNonNull(augmentationType));
    }

    
    public NsConfigurationBuilder setConfigMethod(final ConfigMethod value) {
        this._configMethod = value;
        return this;
    }
    public NsConfigurationBuilder setConfigPrimitive(final Map<ConfigPrimitiveKey, ConfigPrimitive> values) {
    ...
    public NsConfigurationBuilder setConfigPrimitive(final List<ConfigPrimitive> values) {
        return setConfigPrimitive(CodeHelpers.compatMap(values));
    }
    public NsConfigurationBuilder setInitialConfigPrimitive(final Map<InitialConfigPrimitiveKey, InitialConfigPrimitive> values) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NsConfigurationBuilder setInitialConfigPrimitive(final List<InitialConfigPrimitive> values) {
        return setInitialConfigPrimitive(CodeHelpers.compatMap(values));
    }
    public NsConfigurationBuilder setMetrics(final Map<MetricsKey, Metrics> values) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NsConfigurationBuilder setMetrics(final List<Metrics> values) {
        return setMetrics(CodeHelpers.compatMap(values));
    }
    public NsConfigurationBuilder setRelation(final Map<RelationKey, Relation> values) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NsConfigurationBuilder setRelation(final List<Relation> values) {
        return setRelation(CodeHelpers.compatMap(values));
    }
    public NsConfigurationBuilder setTerminateConfigPrimitive(final Map<TerminateConfigPrimitiveKey, TerminateConfigPrimitive> values) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NsConfigurationBuilder setTerminateConfigPrimitive(final List<TerminateConfigPrimitive> values) {
    ...
    /**
      ...
      */
    public NsConfigurationBuilder addAugmentation(Augmentation<NsConfiguration> augmentation) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NsConfigurationBuilder addAugmentation(Class<? extends Augmentation<NsConfiguration>> augmentationType, Augmentation<NsConfiguration> augmentationValue) {
    ...
    /**
      ...
      * @return this builder
      */
    public NsConfigurationBuilder removeAugmentation(Class<? extends Augmentation<NsConfiguration>> augmentationType) {
    ...
    private NsConfigurationBuilder doAddAugmentation(Class<? extends Augmentation<NsConfiguration>> augmentationType, Augmentation<NsConfiguration> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    @Override
    public NsConfiguration build() {
        return new NsConfigurationImpl(this);
    }

    private static final class NsConfigurationImpl
        extends AbstractAugmentable<NsConfiguration>
        implements NsConfiguration {
        ...
        NsConfigurationImpl(NsConfigurationBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!NsConfiguration.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            NsConfiguration other = (NsConfiguration)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                NsConfigurationImpl otherImpl = (NsConfigurationImpl) obj;
                if (!Objects.equals(augmentations(), otherImpl.augmentations())) {
                    return false;
                }
            } else {
                // Hard case: compare our augments with presence there...
                for (Map.Entry<Class<? extends Augmentation<NsConfiguration>>, Augmentation<NsConfiguration>> e : augmentations().entrySet()) {
        ...
        public String toString() {
            final MoreObjects.ToStringHelper helper = MoreObjects.toStringHelper("NsConfiguration");
