...
/**
 * Class that builds {@link ServerGroupBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ServerGroupBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ServerGroupBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ServerGroupBuilder, as instances can be freely passed around without
...
public class ServerGroupBuilder implements Builder<ServerGroup> {
    ...
    public ServerGroupBuilder(ServerGroup base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<ServerGroup>>, Augmentation<ServerGroup>> aug =((AugmentationHolder<ServerGroup>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    private ServerGroupBuilder doAddAugmentation(Class<? extends Augmentation<ServerGroup>> augmentationType, Augmentation<ServerGroup> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ServerGroupImpl
        ...
        public boolean equals(Object obj) {
            ...
            if (!ServerGroup.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ServerGroup>>, Augmentation<ServerGroup>> e : augmentations().entrySet()) {
