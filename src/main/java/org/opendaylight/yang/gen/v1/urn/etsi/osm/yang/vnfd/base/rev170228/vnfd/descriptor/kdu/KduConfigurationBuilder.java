...
/**
 * Class that builds {@link KduConfigurationBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     KduConfigurationBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new KduConfigurationBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of KduConfigurationBuilder, as instances can be freely passed around without
...
public class KduConfigurationBuilder implements Builder<KduConfiguration> {
    ...
    */
    ...
    public KduConfigurationBuilder setConfigPrimitive(final Map<ConfigPrimitiveKey, ConfigPrimitive> values) {
    ...
    public KduConfigurationBuilder setInitialConfigPrimitive(final Map<InitialConfigPrimitiveKey, InitialConfigPrimitive> values) {
    ...
    public KduConfigurationBuilder setMetrics(final Map<MetricsKey, Metrics> values) {
    ...
    public KduConfigurationBuilder setTerminateConfigPrimitive(final Map<TerminateConfigPrimitiveKey, TerminateConfigPrimitive> values) {
    ...
    /**
      ...
      */
    public KduConfigurationBuilder addAugmentation(Augmentation<KduConfiguration> augmentation) {
    ...
    private KduConfigurationBuilder doAddAugmentation(Class<? extends Augmentation<KduConfiguration>> augmentationType, Augmentation<KduConfiguration> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class KduConfigurationImpl
        extends AbstractAugmentable<KduConfiguration>
        implements KduConfiguration {
        ...
        public boolean equals(Object obj) {
            ...
            if (!KduConfiguration.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<KduConfiguration>>, Augmentation<KduConfiguration>> e : augmentations().entrySet()) {
