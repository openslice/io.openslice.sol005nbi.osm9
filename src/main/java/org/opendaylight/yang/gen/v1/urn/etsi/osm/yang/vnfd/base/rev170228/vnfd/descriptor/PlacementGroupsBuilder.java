...
public class PlacementGroupsBuilder implements Builder<PlacementGroups> {
    ...
    private Map<MemberVdusKey, MemberVdus> _memberVdus;
    ...
    */
    ...
    public Map<MemberVdusKey, MemberVdus> getMemberVdus() {
        return _memberVdus;
    }
    ...
    public PlacementGroupsBuilder setMemberVdus(final Map<MemberVdusKey, MemberVdus> values) {
    ...
    /**
      ...
      * @deprecated Use {#link #setMemberVdus(Map)} instead.
      */
    @Deprecated(forRemoval = true)
    public PlacementGroupsBuilder setMemberVdus(final List<MemberVdus> values) {
        return setMemberVdus(CodeHelpers.compatMap(values));
    }
    ...
    private static final class PlacementGroupsImpl
        ...
        private final Map<MemberVdusKey, MemberVdus> _memberVdus;
        ...
        PlacementGroupsImpl(PlacementGroupsBuilder base) {
            ...
            this._memberVdus = CodeHelpers.emptyToNull(base.getMemberVdus());
            this._requirement = base.getRequirement();
            this._strategy = base.getStrategy();
        }
