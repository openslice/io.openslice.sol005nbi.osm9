...
import org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsr.rev170208.Project1;
 ...
 * <i>nsr/project/(urn:etsi:osm:yang:nsr?revision=2017-02-08)key-pair</i>
 * 
    ...
    Identifiable<KeyPairKey>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsr.rev170208.project.KeyPair> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsr.rev170208.project.KeyPair.class;
    }
