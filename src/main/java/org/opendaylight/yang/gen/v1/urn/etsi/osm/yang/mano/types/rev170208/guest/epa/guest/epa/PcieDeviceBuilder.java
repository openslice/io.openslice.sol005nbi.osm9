...
/**
 * Class that builds {@link PcieDeviceBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     PcieDeviceBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new PcieDeviceBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of PcieDeviceBuilder, as instances can be freely passed around without
...
public class PcieDeviceBuilder implements Builder<PcieDevice> {
    ...
    public PcieDeviceBuilder(PcieDevice base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<PcieDevice>>, Augmentation<PcieDevice>> aug =((AugmentationHolder<PcieDevice>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public PcieDeviceBuilder setCount(final Uint64 value) {
        this._count = value;
        return this;
    }
    ...
    /**
      ...
      */
    public PcieDeviceBuilder addAugmentation(Augmentation<PcieDevice> augmentation) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public PcieDeviceBuilder addAugmentation(Class<? extends Augmentation<PcieDevice>> augmentationType, Augmentation<PcieDevice> augmentationValue) {
    ...
    private PcieDeviceBuilder doAddAugmentation(Class<? extends Augmentation<PcieDevice>> augmentationType, Augmentation<PcieDevice> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class PcieDeviceImpl
        extends AbstractAugmentable<PcieDevice>
        implements PcieDevice {
    
        private final Uint64 _count;
        private final String _deviceId;
        private final PcieDeviceKey key;
    
        PcieDeviceImpl(PcieDeviceBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!PcieDevice.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<PcieDevice>>, Augmentation<PcieDevice>> e : augmentations().entrySet()) {
