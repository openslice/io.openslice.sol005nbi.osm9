package org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.vdu.config.access;
...
import org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.vdu.config.access.config.access.SshAccess;
...
/**
 * Class that builds {@link ConfigAccessBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ConfigAccessBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ConfigAccessBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ConfigAccessBuilder, as instances can be freely passed around without
...
public class ConfigAccessBuilder implements Builder<ConfigAccess> {
    ...
    /**
      ...
      */
    public ConfigAccessBuilder addAugmentation(Augmentation<ConfigAccess> augmentation) {
    ...
    private ConfigAccessBuilder doAddAugmentation(Class<? extends Augmentation<ConfigAccess>> augmentationType, Augmentation<ConfigAccess> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ConfigAccessImpl
        extends AbstractAugmentable<ConfigAccess>
        ...
        public boolean equals(Object obj) {
            ...
            if (!ConfigAccess.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ConfigAccess>>, Augmentation<ConfigAccess>> e : augmentations().entrySet()) {
