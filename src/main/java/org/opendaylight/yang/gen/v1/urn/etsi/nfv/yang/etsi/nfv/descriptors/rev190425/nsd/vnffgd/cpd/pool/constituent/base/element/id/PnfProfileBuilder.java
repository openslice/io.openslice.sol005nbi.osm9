...
public class PnfProfileBuilder implements Builder<PnfProfile> {
    ...
    private org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.pnf.profile.PnfProfile _pnfProfile;
    ...
    public org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.pnf.profile.PnfProfile getPnfProfile() {
        return _pnfProfile;
    }
    ...
    public PnfProfileBuilder setPnfProfile(final org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.pnf.profile.PnfProfile value) {
        this._pnfProfile = value;
        return this;
    }
    ...
    private static final class PnfProfileImpl
        ...
        private final org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.pnf.profile.PnfProfile _pnfProfile;
