...
public class VnfdPlacementGroupMapsBuilder implements Builder<VnfdPlacementGroupMaps> {
    ...
    */
    ...
    public VnfdPlacementGroupMapsBuilder setSshAuthorizedKey(final Map<SshAuthorizedKeyKey, SshAuthorizedKey> values) {
    ...
    public VnfdPlacementGroupMapsBuilder setUser(final Map<UserKey, User> values) {
        this._user = values;
        return this;
    }
