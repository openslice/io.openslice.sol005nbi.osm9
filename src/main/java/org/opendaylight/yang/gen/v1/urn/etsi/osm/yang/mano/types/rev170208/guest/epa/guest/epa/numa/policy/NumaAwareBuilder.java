...
/**
 * Class that builds {@link NumaAwareBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NumaAwareBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NumaAwareBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NumaAwareBuilder, as instances can be freely passed around without
...
public class NumaAwareBuilder implements Builder<NumaAware> {
    ...
    public NumaAwareBuilder(NumaAware base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<NumaAware>>, Augmentation<NumaAware>> aug =((AugmentationHolder<NumaAware>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public NumaAwareBuilder addAugmentation(Augmentation<NumaAware> augmentation) {
    ...
    private NumaAwareBuilder doAddAugmentation(Class<? extends Augmentation<NumaAware>> augmentationType, Augmentation<NumaAware> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NumaAwareImpl
        extends AbstractAugmentable<NumaAware>
        implements NumaAware {
    
        private final NumaNodePolicy _numaNodePolicy;
    
        NumaAwareImpl(NumaAwareBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!NumaAware.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NumaAware>>, Augmentation<NumaAware>> e : augmentations().entrySet()) {
