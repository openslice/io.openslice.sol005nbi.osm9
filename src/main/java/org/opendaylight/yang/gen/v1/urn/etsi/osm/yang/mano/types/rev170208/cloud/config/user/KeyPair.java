 ...
 * <i>mano-types/cloud-config/user/key-pair</i>
 * 
    ...
    Identifiable<KeyPairKey>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.cloud.config.user.KeyPair> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.cloud.config.user.KeyPair.class;
    }
