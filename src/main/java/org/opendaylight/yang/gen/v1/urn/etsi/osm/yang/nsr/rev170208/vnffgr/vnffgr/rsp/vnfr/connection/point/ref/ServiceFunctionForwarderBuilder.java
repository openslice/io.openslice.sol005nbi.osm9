...
/**
 * Class that builds {@link ServiceFunctionForwarderBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ServiceFunctionForwarderBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ServiceFunctionForwarderBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ServiceFunctionForwarderBuilder, as instances can be freely passed around without
...
public class ServiceFunctionForwarderBuilder implements Builder<ServiceFunctionForwarder> {
    ...
    public ServiceFunctionForwarderBuilder(ServiceFunctionForwarder base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<ServiceFunctionForwarder>>, Augmentation<ServiceFunctionForwarder>> aug =((AugmentationHolder<ServiceFunctionForwarder>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public ServiceFunctionForwarderBuilder addAugmentation(Augmentation<ServiceFunctionForwarder> augmentation) {
    ...
    private ServiceFunctionForwarderBuilder doAddAugmentation(Class<? extends Augmentation<ServiceFunctionForwarder>> augmentationType, Augmentation<ServiceFunctionForwarder> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ServiceFunctionForwarderImpl
        extends AbstractAugmentable<ServiceFunctionForwarder>
        ...
        ServiceFunctionForwarderImpl(ServiceFunctionForwarderBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!ServiceFunctionForwarder.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ServiceFunctionForwarder>>, Augmentation<ServiceFunctionForwarder>> e : augmentations().entrySet()) {
