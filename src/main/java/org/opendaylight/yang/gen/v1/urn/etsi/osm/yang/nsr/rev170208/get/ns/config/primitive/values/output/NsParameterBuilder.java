...
/**
 * Class that builds {@link NsParameterBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NsParameterBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NsParameterBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NsParameterBuilder, as instances can be freely passed around without
...
public class NsParameterBuilder implements Builder<NsParameter> {
    ...
    public NsParameterBuilder(NsParameter base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<NsParameter>>, Augmentation<NsParameter>> aug =((AugmentationHolder<NsParameter>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public NsParameterBuilder addAugmentation(Augmentation<NsParameter> augmentation) {
    ...
    private NsParameterBuilder doAddAugmentation(Class<? extends Augmentation<NsParameter>> augmentationType, Augmentation<NsParameter> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NsParameterImpl
        extends AbstractAugmentable<NsParameter>
        implements NsParameter {
    
        private final String _name;
        private final String _value;
        private final NsParameterKey key;
    
        NsParameterImpl(NsParameterBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new NsParameterKey(base.getName());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!NsParameter.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NsParameter>>, Augmentation<NsParameter>> e : augmentations().entrySet()) {
