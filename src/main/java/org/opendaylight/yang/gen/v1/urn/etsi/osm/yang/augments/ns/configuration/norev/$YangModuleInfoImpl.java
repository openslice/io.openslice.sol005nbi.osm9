...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final @NonNull QName NAME = QName.create("urn:etsi:osm:yang:augments:ns-configuration", "ns-configuration").intern();
    ...
    protected String resourceName() {
        return "/META-INF/yang/ns-configuration.yang";
    }
