...
/**
 * Class that builds {@link ConfigFileBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ConfigFileBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ConfigFileBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ConfigFileBuilder, as instances can be freely passed around without
...
public class ConfigFileBuilder implements Builder<ConfigFile> {
    ...
    /**
      ...
      */
    public ConfigFileBuilder addAugmentation(Augmentation<ConfigFile> augmentation) {
    ...
    private ConfigFileBuilder doAddAugmentation(Class<? extends Augmentation<ConfigFile>> augmentationType, Augmentation<ConfigFile> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ConfigFileImpl
        extends AbstractAugmentable<ConfigFile>
        ...
        public boolean equals(Object obj) {
            ...
            if (!ConfigFile.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ConfigFile>>, Augmentation<ConfigFile>> e : augmentations().entrySet()) {
