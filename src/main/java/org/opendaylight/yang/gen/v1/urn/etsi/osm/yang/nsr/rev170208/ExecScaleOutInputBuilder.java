...
/**
 * Class that builds {@link ExecScaleOutInputBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ExecScaleOutInputBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ExecScaleOutInputBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ExecScaleOutInputBuilder, as instances can be freely passed around without
...
public class ExecScaleOutInputBuilder implements Builder<ExecScaleOutInput> {
    ...
    public ExecScaleOutInputBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public ExecScaleOutInputBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
    ...
    public ExecScaleOutInputBuilder(ExecScaleOutInput base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<ExecScaleOutInput>>, Augmentation<ExecScaleOutInput>> aug =((AugmentationHolder<ExecScaleOutInput>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    ...
    public ExecScaleOutInputBuilder setInstanceId(final Uint64 value) {
     ...
     * @return this builder
     * @deprecated Use {#link setInstanceId(Uint64)} instead.
     */
    ...
    /**
      ...
      */
    public ExecScaleOutInputBuilder addAugmentation(Augmentation<ExecScaleOutInput> augmentation) {
    ...
    private ExecScaleOutInputBuilder doAddAugmentation(Class<? extends Augmentation<ExecScaleOutInput>> augmentationType, Augmentation<ExecScaleOutInput> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ExecScaleOutInputImpl
        extends AbstractAugmentable<ExecScaleOutInput>
        implements ExecScaleOutInput {
    
        private final Uint64 _instanceId;
        private final Object _nsrIdRef;
        private final String _projectName;
        private final Object _scalingGroupNameRef;
    
        ExecScaleOutInputImpl(ExecScaleOutInputBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!ExecScaleOutInput.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ExecScaleOutInput>>, Augmentation<ExecScaleOutInput>> e : augmentations().entrySet()) {
