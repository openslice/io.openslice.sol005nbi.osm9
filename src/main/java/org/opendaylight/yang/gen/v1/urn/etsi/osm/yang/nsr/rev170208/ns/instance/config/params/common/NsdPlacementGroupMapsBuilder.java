...
/**
 * Class that builds {@link NsdPlacementGroupMapsBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NsdPlacementGroupMapsBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NsdPlacementGroupMapsBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NsdPlacementGroupMapsBuilder, as instances can be freely passed around without
...
public class NsdPlacementGroupMapsBuilder implements Builder<NsdPlacementGroupMaps> {
    ...
    */
    ...
    /**
      ...
      */
    public NsdPlacementGroupMapsBuilder addAugmentation(Augmentation<NsdPlacementGroupMaps> augmentation) {
    ...
    private NsdPlacementGroupMapsBuilder doAddAugmentation(Class<? extends Augmentation<NsdPlacementGroupMaps>> augmentationType, Augmentation<NsdPlacementGroupMaps> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NsdPlacementGroupMapsImpl
        extends AbstractAugmentable<NsdPlacementGroupMaps>
        implements NsdPlacementGroupMaps {
        ...
        public boolean equals(Object obj) {
            ...
            if (!NsdPlacementGroupMaps.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NsdPlacementGroupMaps>>, Augmentation<NsdPlacementGroupMaps>> e : augmentations().entrySet()) {
