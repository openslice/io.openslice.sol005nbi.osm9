...
public class PlacementGroupsInfoKey
 implements Identifier<PlacementGroupsInfo> {
    ...
    public PlacementGroupsInfoKey(String _name) {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof PlacementGroupsInfoKey)) {
            return false;
        }
        final PlacementGroupsInfoKey other = (PlacementGroupsInfoKey) obj;
    ...
    public String toString() {
        final MoreObjects.ToStringHelper helper = MoreObjects.toStringHelper(PlacementGroupsInfoKey.class);
