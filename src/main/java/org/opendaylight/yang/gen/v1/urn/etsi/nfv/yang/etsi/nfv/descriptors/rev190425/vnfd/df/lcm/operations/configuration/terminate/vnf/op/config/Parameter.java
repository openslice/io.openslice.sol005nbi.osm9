 ...
 * <i>etsi-nfv-descriptors/vnfd/df/lcm-operations-configuration/terminate-vnf-op-config/parameter</i>
 * 
    ...
    Identifiable<ParameterKey>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.vnfd.df.lcm.operations.configuration.terminate.vnf.op.config.Parameter> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.vnfd.df.lcm.operations.configuration.terminate.vnf.op.config.Parameter.class;
    }
