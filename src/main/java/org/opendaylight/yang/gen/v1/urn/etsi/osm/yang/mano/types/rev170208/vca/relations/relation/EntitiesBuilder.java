...
/**
 * Class that builds {@link EntitiesBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     EntitiesBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new EntitiesBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of EntitiesBuilder, as instances can be freely passed around without
...
public class EntitiesBuilder implements Builder<Entities> {
    ...
    private EntitiesBuilder doAddAugmentation(Class<? extends Augmentation<Entities>> augmentationType, Augmentation<Entities> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class EntitiesImpl
        ...
        public boolean equals(Object obj) {
            ...
            if (!Entities.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<Entities>>, Augmentation<Entities>> e : augmentations().entrySet()) {
