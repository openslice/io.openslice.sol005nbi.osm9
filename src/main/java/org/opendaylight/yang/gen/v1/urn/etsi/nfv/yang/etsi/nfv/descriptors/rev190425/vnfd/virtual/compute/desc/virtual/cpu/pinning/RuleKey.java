...
public class RuleKey
 implements Identifier<Rule> {
    private static final long serialVersionUID = -7372554665194622883L;
    private final String _key;


    public RuleKey(String _key) {
    ...
    public String toString() {
        final MoreObjects.ToStringHelper helper = MoreObjects.toStringHelper(RuleKey.class);
