...
public class RspBuilder implements Builder<Rsp> {
    ...
    private Map<NsdConnectionPointRefKey, NsdConnectionPointRef> _nsdConnectionPointRef;
    private RspKey key;
    ...
    public RspBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nst.rev180820.Rsp arg) {
     ...
     * <li>org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nst.rev180820.Rsp</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nst.rev180820.Rsp) {
            this._nsdConnectionPointRef = ((org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nst.rev180820.Rsp)arg).getNsdConnectionPointRef();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsd.base.rev170228.RspCommon, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nst.rev180820.Rsp]");
    }
    ...
    public Map<NsdConnectionPointRefKey, NsdConnectionPointRef> getNsdConnectionPointRef() {
    ...
    public RspBuilder setNsdConnectionPointRef(final Map<NsdConnectionPointRefKey, NsdConnectionPointRef> values) {
        this._nsdConnectionPointRef = values;
        return this;
    }
    ...
    /**
      ...
      * @deprecated Use {#link #setNsdConnectionPointRef(Map)} instead.
      */
    @Deprecated(forRemoval = true)
    public RspBuilder setNsdConnectionPointRef(final List<NsdConnectionPointRef> values) {
        return setNsdConnectionPointRef(CodeHelpers.compatMap(values));
    }
    ...
    private static final class RspImpl
        ...
        private final Map<NsdConnectionPointRefKey, NsdConnectionPointRef> _nsdConnectionPointRef;
        ...
        RspImpl(RspBuilder base) {
            ...
            this._id = key.getId();
            this._name = base.getName();
            this._nsdConnectionPointRef = CodeHelpers.emptyToNull(base.getNsdConnectionPointRef());
        }
