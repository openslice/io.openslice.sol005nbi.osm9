...
import org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.execution.environment.list.ExecutionEnvironmentListKey;
...
public class ExecutionEnvironmentListBuilder implements Builder<ExecutionEnvironmentList> {
    ...
    private Map<ExecutionEnvironmentListKey, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.execution.environment.list.ExecutionEnvironmentList> _executionEnvironmentList;
    ...
    public Map<ExecutionEnvironmentListKey, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.execution.environment.list.ExecutionEnvironmentList> getExecutionEnvironmentList() {
    ...
    public ExecutionEnvironmentListBuilder setExecutionEnvironmentList(final Map<ExecutionEnvironmentListKey, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.execution.environment.list.ExecutionEnvironmentList> values) {
    ...
    public ExecutionEnvironmentListBuilder setExecutionEnvironmentList(final List<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.execution.environment.list.ExecutionEnvironmentList> values) {
    ...
    private static final class ExecutionEnvironmentListImpl
        ...
        private final Map<ExecutionEnvironmentListKey, org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.execution.environment.list.ExecutionEnvironmentList> _executionEnvironmentList;
