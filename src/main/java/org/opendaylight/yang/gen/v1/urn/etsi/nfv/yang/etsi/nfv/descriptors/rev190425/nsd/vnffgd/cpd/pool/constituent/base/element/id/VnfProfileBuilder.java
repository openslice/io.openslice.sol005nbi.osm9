...
public class VnfProfileBuilder implements Builder<VnfProfile> {
    ...
    private org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.vnf.profile.VnfProfile _vnfProfile;
    ...
    public org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.vnf.profile.VnfProfile getVnfProfile() {
        return _vnfProfile;
    }
    ...
    public VnfProfileBuilder setVnfProfile(final org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.vnf.profile.VnfProfile value) {
        this._vnfProfile = value;
        return this;
    }
    ...
    private static final class VnfProfileImpl
        ...
        private final org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.nsd.vnffgd.cpd.pool.constituent.base.element.id.vnf.profile.VnfProfile _vnfProfile;
