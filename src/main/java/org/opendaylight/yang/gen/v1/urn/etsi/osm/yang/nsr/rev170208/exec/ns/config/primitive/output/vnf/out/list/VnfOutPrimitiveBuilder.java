...
/**
 * Class that builds {@link VnfOutPrimitiveBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VnfOutPrimitiveBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VnfOutPrimitiveBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VnfOutPrimitiveBuilder, as instances can be freely passed around without
...
public class VnfOutPrimitiveBuilder implements Builder<VnfOutPrimitive> {
    ...
    public VnfOutPrimitiveBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.PrimitiveParameterValue arg) {
    ...
    public VnfOutPrimitiveBuilder(VnfOutPrimitive base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<VnfOutPrimitive>>, Augmentation<VnfOutPrimitive>> aug =((AugmentationHolder<VnfOutPrimitive>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    ...
    public VnfOutPrimitiveBuilder setIndex(final Uint32 value) {
        this._index = value;
        return this;
    }
    ...
    public VnfOutPrimitiveBuilder setParameter(final Map<ParameterKey, Parameter> values) {
    ...
    /**
      ...
      */
    public VnfOutPrimitiveBuilder addAugmentation(Augmentation<VnfOutPrimitive> augmentation) {
    ...
    private VnfOutPrimitiveBuilder doAddAugmentation(Class<? extends Augmentation<VnfOutPrimitive>> augmentationType, Augmentation<VnfOutPrimitive> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VnfOutPrimitiveImpl
        extends AbstractAugmentable<VnfOutPrimitive>
        implements VnfOutPrimitive {
        ...
        VnfOutPrimitiveImpl(VnfOutPrimitiveBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new VnfOutPrimitiveKey(base.getIndex());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!VnfOutPrimitive.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VnfOutPrimitive>>, Augmentation<VnfOutPrimitive>> e : augmentations().entrySet()) {
