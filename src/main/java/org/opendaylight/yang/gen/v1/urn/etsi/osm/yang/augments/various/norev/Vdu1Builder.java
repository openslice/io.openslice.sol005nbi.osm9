...
public class Vdu1Builder implements Builder<Vdu1> {
    ...
    public Vdu1Builder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.various.norev.ExtendedVdu arg) {
        this._pduType = arg.getPduType();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.various.norev.ExtendedVdu</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.various.norev.ExtendedVdu) {
            this._pduType = ((org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.various.norev.ExtendedVdu)arg).getPduType();
            this._supplementalBootData = ((org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.various.norev.ExtendedVdu)arg).getSupplementalBootData();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.various.norev.ExtendedVdu]");
    }
    ...
    public Vdu1Builder setPduType(final String value) {
        this._pduType = value;
        return this;
    }
    
    public Vdu1Builder setSupplementalBootData(final SupplementalBootData value) {
