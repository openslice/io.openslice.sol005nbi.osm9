...
/**
 * Class that builds {@link ExecScaleOutOutputBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ExecScaleOutOutputBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ExecScaleOutOutputBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ExecScaleOutOutputBuilder, as instances can be freely passed around without
...
public class ExecScaleOutOutputBuilder implements Builder<ExecScaleOutOutput> {
    ...
    public ExecScaleOutOutputBuilder setInstanceId(final Uint64 value) {
    ...
    /**
      ...
      */
    public ExecScaleOutOutputBuilder addAugmentation(Augmentation<ExecScaleOutOutput> augmentation) {
    ...
    private ExecScaleOutOutputBuilder doAddAugmentation(Class<? extends Augmentation<ExecScaleOutOutput>> augmentationType, Augmentation<ExecScaleOutOutput> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ExecScaleOutOutputImpl
        extends AbstractAugmentable<ExecScaleOutOutput>
        implements ExecScaleOutOutput {
        ...
        public boolean equals(Object obj) {
            ...
            if (!ExecScaleOutOutput.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ExecScaleOutOutput>>, Augmentation<ExecScaleOutOutput>> e : augmentations().entrySet()) {
