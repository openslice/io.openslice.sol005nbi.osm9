...
/**
 * Class that builds {@link InternalBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     InternalBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new InternalBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of InternalBuilder, as instances can be freely passed around without
...
public class InternalBuilder implements Builder<Internal> {
    ...
    public InternalBuilder(Internal base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<Internal>>, Augmentation<Internal>> aug =((AugmentationHolder<Internal>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public InternalBuilder addAugmentation(Augmentation<Internal> augmentation) {
    ...
    private InternalBuilder doAddAugmentation(Class<? extends Augmentation<Internal>> augmentationType, Augmentation<Internal> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class InternalImpl
        extends AbstractAugmentable<Internal>
        implements Internal {
    
        private final String _internalConnectionPointRef;
    
        InternalImpl(InternalBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!Internal.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<Internal>>, Augmentation<Internal>> e : augmentations().entrySet()) {
