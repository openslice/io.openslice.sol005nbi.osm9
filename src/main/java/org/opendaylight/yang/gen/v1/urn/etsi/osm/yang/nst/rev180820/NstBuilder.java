...
/**
 * Class that builds {@link NstBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NstBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NstBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NstBuilder, as instances can be freely passed around without
...
public class NstBuilder implements Builder<Nst> {
    ...
    */
    ...
    public NstBuilder setNetsliceConnectionPoint(final Map<NetsliceConnectionPointKey, NetsliceConnectionPoint> values) {
    ...
    public NstBuilder setNetsliceSubnet(final Map<NetsliceSubnetKey, NetsliceSubnet> values) {
    ...
    public NstBuilder setNetsliceVld(final Map<NetsliceVldKey, NetsliceVld> values) {
    ...
    public NstBuilder setNetslicefgd(final Map<NetslicefgdKey, Netslicefgd> values) {
    ...
    /**
      ...
      */
    public NstBuilder addAugmentation(Augmentation<Nst> augmentation) {
    ...
    private NstBuilder doAddAugmentation(Class<? extends Augmentation<Nst>> augmentationType, Augmentation<Nst> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NstImpl
        extends AbstractAugmentable<Nst>
        implements Nst {
        ...
        public boolean equals(Object obj) {
            ...
            if (!Nst.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            Nst other = (Nst)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<Nst>>, Augmentation<Nst>> e : augmentations().entrySet()) {
