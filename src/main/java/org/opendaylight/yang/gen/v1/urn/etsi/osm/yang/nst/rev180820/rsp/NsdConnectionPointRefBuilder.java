...
/**
 * Class that builds {@link NsdConnectionPointRefBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NsdConnectionPointRefBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NsdConnectionPointRefBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NsdConnectionPointRefBuilder, as instances can be freely passed around without
...
public class NsdConnectionPointRefBuilder implements Builder<NsdConnectionPointRef> {
    ...
    public NsdConnectionPointRefBuilder setOrder(final Uint8 value) {
        this._order = value;
        return this;
    }
     ...
     * @return this builder
     * @deprecated Use {#link setOrder(Uint8)} instead.
     */
    @Deprecated(forRemoval = true)
    public NsdConnectionPointRefBuilder setOrder(final Short value) {
        return setOrder(CodeHelpers.compatUint(value));
    }
    ...
    /**
      ...
      */
    public NsdConnectionPointRefBuilder addAugmentation(Augmentation<NsdConnectionPointRef> augmentation) {
    ...
    private NsdConnectionPointRefBuilder doAddAugmentation(Class<? extends Augmentation<NsdConnectionPointRef>> augmentationType, Augmentation<NsdConnectionPointRef> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NsdConnectionPointRefImpl
        extends AbstractAugmentable<NsdConnectionPointRef>
        implements NsdConnectionPointRef {
    
        private final String _nsdConnectionPointRef;
        private final String _nsdRef;
        private final Uint8 _order;
        ...
        public boolean equals(Object obj) {
            ...
            if (!NsdConnectionPointRef.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NsdConnectionPointRef>>, Augmentation<NsdConnectionPointRef>> e : augmentations().entrySet()) {
