...
public class ConstituentCpdIdBuilder implements Builder<ConstituentCpdId> {
    ...
    private String _constituentBaseElementId;
    ...
    public ConstituentCpdIdBuilder setConstituentBaseElementId(final String value) {
    ...
    private static final class ConstituentCpdIdImpl
        ...
        ConstituentCpdIdImpl(ConstituentCpdIdBuilder base) {
            ...
            if (base.key() != null) {
                ...
                this.key = new ConstituentCpdIdKey(base.getConstituentBaseElementId());
            }
