...
/**
 * Class that builds {@link VnfPrimitiveGroupBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VnfPrimitiveGroupBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VnfPrimitiveGroupBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VnfPrimitiveGroupBuilder, as instances can be freely passed around without
...
public class VnfPrimitiveGroupBuilder implements Builder<VnfPrimitiveGroup> {
    ...
    public VnfPrimitiveGroupBuilder setPrimitive(final Map<PrimitiveKey, Primitive> values) {
    ...
    /**
      ...
      */
    public VnfPrimitiveGroupBuilder addAugmentation(Augmentation<VnfPrimitiveGroup> augmentation) {
    ...
    private VnfPrimitiveGroupBuilder doAddAugmentation(Class<? extends Augmentation<VnfPrimitiveGroup>> augmentationType, Augmentation<VnfPrimitiveGroup> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VnfPrimitiveGroupImpl
        extends AbstractAugmentable<VnfPrimitiveGroup>
        implements VnfPrimitiveGroup {
        ...
        public boolean equals(Object obj) {
            ...
            if (!VnfPrimitiveGroup.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VnfPrimitiveGroup>>, Augmentation<VnfPrimitiveGroup>> e : augmentations().entrySet()) {
