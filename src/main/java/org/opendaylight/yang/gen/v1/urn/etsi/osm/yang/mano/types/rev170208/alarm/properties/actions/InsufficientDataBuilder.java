...
/**
 * Class that builds {@link InsufficientDataBuilder} instances. Overall design of the class is that of a
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of InsufficientDataBuilder, as instances can be freely passed around without
...
public class InsufficientDataBuilder implements Builder<InsufficientData> {
    ...
    public InsufficientDataBuilder(InsufficientData base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<InsufficientData>>, Augmentation<InsufficientData>> aug =((AugmentationHolder<InsufficientData>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public InsufficientDataBuilder addAugmentation(Augmentation<InsufficientData> augmentation) {
    ...
    private InsufficientDataBuilder doAddAugmentation(Class<? extends Augmentation<InsufficientData>> augmentationType, Augmentation<InsufficientData> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class InsufficientDataImpl
        extends AbstractAugmentable<InsufficientData>
        implements InsufficientData {
    
        private final String _url;
        private final InsufficientDataKey key;
    
        InsufficientDataImpl(InsufficientDataBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new InsufficientDataKey(base.getUrl());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!InsufficientData.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<InsufficientData>>, Augmentation<InsufficientData>> e : augmentations().entrySet()) {
