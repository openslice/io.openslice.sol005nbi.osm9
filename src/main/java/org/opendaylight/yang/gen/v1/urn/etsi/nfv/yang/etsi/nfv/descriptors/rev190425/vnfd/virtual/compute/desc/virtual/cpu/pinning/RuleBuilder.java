...
public class RuleBuilder implements Builder<Rule> {
    ...
    public RuleBuilder(Rule base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<Rule>>, Augmentation<Rule>> aug =((AugmentationHolder<Rule>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public RuleBuilder setKey(final String value) {
        this._key = value;
        return this;
    }
    
    public RuleBuilder setValue(final String value) {
        this._value = value;
        return this;
    }
    ...
    public RuleBuilder addAugmentation(Class<? extends Augmentation<Rule>> augmentationType, Augmentation<Rule> augmentationValue) {
    ...
    private RuleBuilder doAddAugmentation(Class<? extends Augmentation<Rule>> augmentationType, Augmentation<Rule> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class RuleImpl
        ...
        RuleImpl(RuleBuilder base) {
            ...
            if (base.key() != null) {
                ...
                this.key = new RuleKey(base.getKey());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!Rule.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            Rule other = (Rule)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                RuleImpl otherImpl = (RuleImpl) obj;
                if (!Objects.equals(augmentations(), otherImpl.augmentations())) {
                    return false;
                }
            } else {
                // Hard case: compare our augments with presence there...
                for (Map.Entry<Class<? extends Augmentation<Rule>>, Augmentation<Rule>> e : augmentations().entrySet()) {
