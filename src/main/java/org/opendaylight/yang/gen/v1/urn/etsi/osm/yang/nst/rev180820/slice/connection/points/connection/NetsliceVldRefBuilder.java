...
/**
 * Class that builds {@link NetsliceVldRefBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NetsliceVldRefBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NetsliceVldRefBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NetsliceVldRefBuilder, as instances can be freely passed around without
...
public class NetsliceVldRefBuilder implements Builder<NetsliceVldRef> {
    ...
    private Object _netsliceVldIdRef;
    ...
    public Object getNetsliceVldIdRef() {
    ...
    public NetsliceVldRefBuilder setNetsliceVldIdRef(final Object value) {
    ...
    /**
      ...
      */
    public NetsliceVldRefBuilder addAugmentation(Augmentation<NetsliceVldRef> augmentation) {
    ...
    private NetsliceVldRefBuilder doAddAugmentation(Class<? extends Augmentation<NetsliceVldRef>> augmentationType, Augmentation<NetsliceVldRef> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NetsliceVldRefImpl
        extends AbstractAugmentable<NetsliceVldRef>
        implements NetsliceVldRef {
    
        private final Object _netsliceVldIdRef;
        ...
        public boolean equals(Object obj) {
            ...
            if (!NetsliceVldRef.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NetsliceVldRef>>, Augmentation<NetsliceVldRef>> e : augmentations().entrySet()) {
