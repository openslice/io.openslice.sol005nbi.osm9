...
/**
 * Class that builds {@link NfvBuilder} instances. Overall design of the class is that of a
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NfvBuilder, as instances can be freely passed around without
 ...
 *
 */
public class NfvBuilder implements Builder<Nfv> {

    private Map<NsdKey, Nsd> _nsd;
    private Map<PnfdKey, Pnfd> _pnfd;
    private Map<VnfdKey, Vnfd> _vnfd;


    Map<Class<? extends Augmentation<Nfv>>, Augmentation<Nfv>> augmentation = Collections.emptyMap();

    public NfvBuilder() {
    }

    public NfvBuilder(Nfv base) {
        if (base instanceof AugmentationHolder) {
            @SuppressWarnings("unchecked")
            Map<Class<? extends Augmentation<Nfv>>, Augmentation<Nfv>> aug =((AugmentationHolder<Nfv>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public <E$$ extends Augmentation<Nfv>> E$$ augmentation(Class<E$$> augmentationType) {
        return (E$$) augmentation.get(Objects.requireNonNull(augmentationType));
    }

    public NfvBuilder setNsd(final Map<NsdKey, Nsd> values) {
        this._nsd = values;
        return this;
    }
    ...
    public NfvBuilder setNsd(final List<Nsd> values) {
        return setNsd(CodeHelpers.compatMap(values));
    }
    public NfvBuilder setPnfd(final Map<PnfdKey, Pnfd> values) {
        this._pnfd = values;
        return this;
    }
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NfvBuilder setPnfd(final List<Pnfd> values) {
        return setPnfd(CodeHelpers.compatMap(values));
    }
    public NfvBuilder setVnfd(final Map<VnfdKey, Vnfd> values) {
        this._vnfd = values;
        return this;
    }
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NfvBuilder setVnfd(final List<Vnfd> values) {
    ...
    /**
      ...
      */
    public NfvBuilder addAugmentation(Augmentation<Nfv> augmentation) {
    ...
    /**
      ...
      */
    @Deprecated(forRemoval = true)
    public NfvBuilder addAugmentation(Class<? extends Augmentation<Nfv>> augmentationType, Augmentation<Nfv> augmentationValue) {
    ...
    /**
      ...
      * @return this builder
      */
    public NfvBuilder removeAugmentation(Class<? extends Augmentation<Nfv>> augmentationType) {
    ...
    private NfvBuilder doAddAugmentation(Class<? extends Augmentation<Nfv>> augmentationType, Augmentation<Nfv> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    @Override
    public Nfv build() {
        return new NfvImpl(this);
    }

    private static final class NfvImpl
        extends AbstractAugmentable<Nfv>
        implements Nfv {
    
        private final Map<NsdKey, Nsd> _nsd;
        private final Map<PnfdKey, Pnfd> _pnfd;
        private final Map<VnfdKey, Vnfd> _vnfd;
    
        NfvImpl(NfvBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!Nfv.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            Nfv other = (Nfv)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                NfvImpl otherImpl = (NfvImpl) obj;
                if (!Objects.equals(augmentations(), otherImpl.augmentations())) {
                    return false;
                }
            } else {
                // Hard case: compare our augments with presence there...
                for (Map.Entry<Class<? extends Augmentation<Nfv>>, Augmentation<Nfv>> e : augmentations().entrySet()) {
        ...
        public String toString() {
            final MoreObjects.ToStringHelper helper = MoreObjects.toStringHelper("Nfv");
