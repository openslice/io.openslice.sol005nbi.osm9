...
/**
 * Class that builds {@link InlineBuilder} instances. Overall design of the class is that of a
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of InlineBuilder, as instances can be freely passed around without
...
public class InlineBuilder implements Builder<Inline> {
    ...
    public InlineBuilder(Inline base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<Inline>>, Augmentation<Inline>> aug =((AugmentationHolder<Inline>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    private InlineBuilder doAddAugmentation(Class<? extends Augmentation<Inline>> augmentationType, Augmentation<Inline> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class InlineImpl
        extends AbstractAugmentable<Inline>
        implements Inline {
    
        private final String _cloudInit;
    
        InlineImpl(InlineBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!Inline.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<Inline>>, Augmentation<Inline>> e : augmentations().entrySet()) {
