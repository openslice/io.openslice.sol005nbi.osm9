...
public class VnfDependencyBuilder implements Builder<VnfDependency> {
    ...
    private static void check_vnfDependsOnRefLength(final String value) {
    ...
    public VnfDependencyBuilder setVnfDependsOnRef(final String value) {
        if (value != null) {
            check_vnfDependsOnRefLength(value);
    ...
    private static void check_vnfSourceRefLength(final String value) {
        final int length = value.length();
        if (length >= 1 && length <= 63) {
            return;
        }
    ...
    public VnfDependencyBuilder setVnfSourceRef(final String value) {
        if (value != null) {
            check_vnfSourceRefLength(value);
