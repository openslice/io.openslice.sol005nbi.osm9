...
/**
 * Class that builds {@link NsdCatalogBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NsdCatalogBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NsdCatalogBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NsdCatalogBuilder, as instances can be freely passed around without
...
public class NsdCatalogBuilder implements Builder<NsdCatalog> {
    ...
    public NsdCatalogBuilder(NsdCatalog base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<NsdCatalog>>, Augmentation<NsdCatalog>> aug =((AugmentationHolder<NsdCatalog>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public NsdCatalogBuilder setNsd(final Map<NsdKey, Nsd> values) {
        this._nsd = values;
        return this;
    }
    ...
    /**
      ...
      */
    public NsdCatalogBuilder addAugmentation(Augmentation<NsdCatalog> augmentation) {
    ...
    private NsdCatalogBuilder doAddAugmentation(Class<? extends Augmentation<NsdCatalog>> augmentationType, Augmentation<NsdCatalog> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NsdCatalogImpl
        extends AbstractAugmentable<NsdCatalog>
        implements NsdCatalog {
    
        private final Map<NsdKey, Nsd> _nsd;
    
        NsdCatalogImpl(NsdCatalogBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!NsdCatalog.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NsdCatalog>>, Augmentation<NsdCatalog>> e : augmentations().entrySet()) {
