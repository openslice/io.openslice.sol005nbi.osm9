 ...
 * <i>common-augments/configuration-method/config-method/juju/juju</i>
 * 
    ...
    Augmentable<Juju>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.configuration.method.config.method.juju.Juju> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.configuration.method.config.method.juju.Juju.class;
    }
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.configuration.method.config.method.juju.Juju.Cloud</code> <code>cloud</code>, or <code>null</code> if not present
     */
