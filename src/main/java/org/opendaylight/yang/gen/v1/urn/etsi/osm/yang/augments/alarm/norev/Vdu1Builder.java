...
public class Vdu1Builder implements Builder<Vdu1> {
    ...
    public Vdu1Builder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.alarm.norev.ExtendedAlarm arg) {
        this._alarm = arg.getAlarm();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.alarm.norev.ExtendedAlarm</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.alarm.norev.ExtendedAlarm) {
            this._alarm = ((org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.alarm.norev.ExtendedAlarm)arg).getAlarm();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.alarm.norev.ExtendedAlarm]");
    }
    ...
    public Vdu1Builder setAlarm(final Map<AlarmKey, Alarm> values) {
        this._alarm = values;
        return this;
    }
    ...
    public Vdu1Builder setAlarm(final List<Alarm> values) {
