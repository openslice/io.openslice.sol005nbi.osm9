...
public class PnfBuilder implements Builder<Pnf> {
    ...
    public PnfBuilder(Pnf base) {
        ...
        this._pnfCpdId = base.getPnfCpdId();
    ...
    public PnfBuilder setPnfCpdId(final String value) {
        this._pnfCpdId = value;
        return this;
    }
    ...
    private static final class PnfImpl
        ...
        private final String _pnfCpdId;
        ...
        public int hashCode() {
            ...
            final int prime = 31;
            int result = 1;
            result = prime * result + Objects.hashCode(_pnfCpdId);
        ...
        public boolean equals(Object obj) {
            ...
            Pnf other = (Pnf)obj;
            if (!Objects.equals(_pnfCpdId, other.getPnfCpdId())) {
                return false;
            }
        ...
        public String toString() {
            ...
            CodeHelpers.appendValue(helper, "_pnfCpdId", _pnfCpdId);
