...
/**
 * Class that builds {@link InternalVlrBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     InternalVlrBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new InternalVlrBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of InternalVlrBuilder, as instances can be freely passed around without
...
public class InternalVlrBuilder implements Builder<InternalVlr> {
    ...
    public InternalVlrBuilder(InternalVlr base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<InternalVlr>>, Augmentation<InternalVlr>> aug =((AugmentationHolder<InternalVlr>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public InternalVlrBuilder addAugmentation(Augmentation<InternalVlr> augmentation) {
    ...
    private InternalVlrBuilder doAddAugmentation(Class<? extends Augmentation<InternalVlr>> augmentationType, Augmentation<InternalVlr> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class InternalVlrImpl
        extends AbstractAugmentable<InternalVlr>
        implements InternalVlr {
    
        private final List<String> _internalConnectionPointRef;
        private final Uuid _vlrRef;
        private final InternalVlrKey key;
    
        InternalVlrImpl(InternalVlrBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new InternalVlrKey(base.getVlrRef());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!InternalVlr.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<InternalVlr>>, Augmentation<InternalVlr>> e : augmentations().entrySet()) {
