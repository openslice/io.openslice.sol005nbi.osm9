...
/**
 * Class that builds {@link DashboardParamsBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     DashboardParamsBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new DashboardParamsBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of DashboardParamsBuilder, as instances can be freely passed around without
...
public class DashboardParamsBuilder implements Builder<DashboardParams> {
    ...
    public DashboardParamsBuilder(DashboardParams base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<DashboardParams>>, Augmentation<DashboardParams>> aug =((AugmentationHolder<DashboardParams>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public DashboardParamsBuilder addAugmentation(Augmentation<DashboardParams> augmentation) {
    ...
    private DashboardParamsBuilder doAddAugmentation(Class<? extends Augmentation<DashboardParams>> augmentationType, Augmentation<DashboardParams> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class DashboardParamsImpl
        extends AbstractAugmentable<DashboardParams>
        implements DashboardParams {
    
        private final String _path;
        private final PortNumber _port;
        private final Boolean _https;
    
        DashboardParamsImpl(DashboardParamsBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!DashboardParams.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<DashboardParams>>, Augmentation<DashboardParams>> e : augmentations().entrySet()) {
