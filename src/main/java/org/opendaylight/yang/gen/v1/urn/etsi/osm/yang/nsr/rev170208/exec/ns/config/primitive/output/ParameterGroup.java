 ...
 * <i>nsr/exec-ns-config-primitive/output/parameter-group</i>
 * 
    ...
    Identifiable<ParameterGroupKey>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsr.rev170208.exec.ns.config.primitive.output.ParameterGroup> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsr.rev170208.exec.ns.config.primitive.output.ParameterGroup.class;
    }
