...
/**
 * Class that builds {@link NsrRefListBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     NsrRefListBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new NsrRefListBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of NsrRefListBuilder, as instances can be freely passed around without
...
public class NsrRefListBuilder implements Builder<NsrRefList> {
    ...
    /**
      ...
      */
    public NsrRefListBuilder addAugmentation(Augmentation<NsrRefList> augmentation) {
    ...
    private NsrRefListBuilder doAddAugmentation(Class<? extends Augmentation<NsrRefList>> augmentationType, Augmentation<NsrRefList> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class NsrRefListImpl
        extends AbstractAugmentable<NsrRefList>
        implements NsrRefList {
        ...
        public boolean equals(Object obj) {
            ...
            if (!NsrRefList.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<NsrRefList>>, Augmentation<NsrRefList>> e : augmentations().entrySet()) {
