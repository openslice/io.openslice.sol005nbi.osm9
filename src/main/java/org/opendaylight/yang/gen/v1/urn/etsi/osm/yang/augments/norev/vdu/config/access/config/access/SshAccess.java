 ...
 * <i>common-augments/vdu-config-access/config-access/ssh-access</i>
 * 
    ...
    Augmentable<SshAccess>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.vdu.config.access.config.access.SshAccess> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.norev.vdu.config.access.config.access.SshAccess.class;
    }
