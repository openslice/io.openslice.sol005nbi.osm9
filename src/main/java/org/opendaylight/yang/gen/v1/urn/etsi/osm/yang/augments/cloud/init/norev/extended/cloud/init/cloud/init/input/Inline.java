 ...
 * <i>cloud-init/extended-cloud-init/cloud-init-input/inline</i>
 *
 */
    ...
    CloudInitInput
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.cloud.init.norev.extended.cloud.init.cloud.init.input.Inline> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.augments.cloud.init.norev.extended.cloud.init.cloud.init.input.Inline.class;
    }
