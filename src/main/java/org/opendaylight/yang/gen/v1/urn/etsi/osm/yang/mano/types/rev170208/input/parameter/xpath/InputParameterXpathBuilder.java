...
/**
 * Class that builds {@link InputParameterXpathBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     InputParameterXpathBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new InputParameterXpathBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of InputParameterXpathBuilder, as instances can be freely passed around without
...
public class InputParameterXpathBuilder implements Builder<InputParameterXpath> {
    ...
    public InputParameterXpathBuilder(InputParameterXpath base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<InputParameterXpath>>, Augmentation<InputParameterXpath>> aug =((AugmentationHolder<InputParameterXpath>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public InputParameterXpathBuilder addAugmentation(Augmentation<InputParameterXpath> augmentation) {
    ...
    private InputParameterXpathBuilder doAddAugmentation(Class<? extends Augmentation<InputParameterXpath>> augmentationType, Augmentation<InputParameterXpath> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class InputParameterXpathImpl
        extends AbstractAugmentable<InputParameterXpath>
        implements InputParameterXpath {
        ...
        InputParameterXpathImpl(InputParameterXpathBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new InputParameterXpathKey(base.getXpath());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!InputParameterXpath.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<InputParameterXpath>>, Augmentation<InputParameterXpath>> e : augmentations().entrySet()) {
