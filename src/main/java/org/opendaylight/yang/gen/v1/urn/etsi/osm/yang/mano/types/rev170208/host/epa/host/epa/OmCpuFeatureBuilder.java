...
/**
 * Class that builds {@link OmCpuFeatureBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     OmCpuFeatureBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new OmCpuFeatureBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of OmCpuFeatureBuilder, as instances can be freely passed around without
...
public class OmCpuFeatureBuilder implements Builder<OmCpuFeature> {
    ...
    /**
      ...
      */
    public OmCpuFeatureBuilder addAugmentation(Augmentation<OmCpuFeature> augmentation) {
    ...
    private OmCpuFeatureBuilder doAddAugmentation(Class<? extends Augmentation<OmCpuFeature>> augmentationType, Augmentation<OmCpuFeature> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class OmCpuFeatureImpl
        extends AbstractAugmentable<OmCpuFeature>
        implements OmCpuFeature {
        ...
        public boolean equals(Object obj) {
            ...
            if (!OmCpuFeature.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<OmCpuFeature>>, Augmentation<OmCpuFeature>> e : augmentations().entrySet()) {
