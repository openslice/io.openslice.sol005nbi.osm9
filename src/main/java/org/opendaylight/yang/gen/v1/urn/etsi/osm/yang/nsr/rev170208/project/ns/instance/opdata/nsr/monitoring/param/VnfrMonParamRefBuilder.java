...
/**
 * Class that builds {@link VnfrMonParamRefBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VnfrMonParamRefBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VnfrMonParamRefBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VnfrMonParamRefBuilder, as instances can be freely passed around without
...
public class VnfrMonParamRefBuilder implements Builder<VnfrMonParamRef> {
    ...
    /**
      ...
      */
    public VnfrMonParamRefBuilder addAugmentation(Augmentation<VnfrMonParamRef> augmentation) {
    ...
    private VnfrMonParamRefBuilder doAddAugmentation(Class<? extends Augmentation<VnfrMonParamRef>> augmentationType, Augmentation<VnfrMonParamRef> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VnfrMonParamRefImpl
        extends AbstractAugmentable<VnfrMonParamRef>
        implements VnfrMonParamRef {
        ...
        public boolean equals(Object obj) {
            ...
            if (!VnfrMonParamRef.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VnfrMonParamRef>>, Augmentation<VnfrMonParamRef>> e : augmentations().entrySet()) {
