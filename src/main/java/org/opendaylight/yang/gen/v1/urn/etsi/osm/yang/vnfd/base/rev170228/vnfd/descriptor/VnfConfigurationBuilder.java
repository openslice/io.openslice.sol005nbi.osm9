...
/**
 * Class that builds {@link VnfConfigurationBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VnfConfigurationBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VnfConfigurationBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VnfConfigurationBuilder, as instances can be freely passed around without
...
public class VnfConfigurationBuilder implements Builder<VnfConfiguration> {
    ...
    */
    ...
    public VnfConfigurationBuilder setConfigPrimitive(final Map<ConfigPrimitiveKey, ConfigPrimitive> values) {
    ...
    public VnfConfigurationBuilder setInitialConfigPrimitive(final Map<InitialConfigPrimitiveKey, InitialConfigPrimitive> values) {
    ...
    public VnfConfigurationBuilder setMetrics(final Map<MetricsKey, Metrics> values) {
    ...
    public VnfConfigurationBuilder setRelation(final Map<RelationKey, Relation> values) {
    ...
    public VnfConfigurationBuilder setTerminateConfigPrimitive(final Map<TerminateConfigPrimitiveKey, TerminateConfigPrimitive> values) {
    ...
    /**
      ...
      */
    public VnfConfigurationBuilder addAugmentation(Augmentation<VnfConfiguration> augmentation) {
    ...
    private VnfConfigurationBuilder doAddAugmentation(Class<? extends Augmentation<VnfConfiguration>> augmentationType, Augmentation<VnfConfiguration> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VnfConfigurationImpl
        extends AbstractAugmentable<VnfConfiguration>
        implements VnfConfiguration {
        ...
        public boolean equals(Object obj) {
            ...
            if (!VnfConfiguration.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VnfConfiguration>>, Augmentation<VnfConfiguration>> e : augmentations().entrySet()) {
