...
/**
 * Class that builds {@link CpBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     CpBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new CpBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of CpBuilder, as instances can be freely passed around without
...
public class CpBuilder implements Builder<Cp> {
    ...
    public CpBuilder(Cp base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<Cp>>, Augmentation<Cp>> aug =((AugmentationHolder<Cp>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public CpBuilder addAugmentation(Augmentation<Cp> augmentation) {
    ...
    private CpBuilder doAddAugmentation(Class<? extends Augmentation<Cp>> augmentationType, Augmentation<Cp> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class CpImpl
        extends AbstractAugmentable<Cp>
        implements Cp {
    
        private final String _cp;
    
        CpImpl(CpBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!Cp.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            Cp other = (Cp)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<Cp>>, Augmentation<Cp>> e : augmentations().entrySet()) {
