 ...
 * <i>etsi-nfv-descriptors/vnfd/df/virtual-link-profile/virtual-link-protocol-data</i>
 * 
    ...
    Augmentable<VirtualLinkProtocolData>
{
    ...
    @Override
    default Class<org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.vnfd.df.virtual.link.profile.VirtualLinkProtocolData> implementedInterface() {
        return org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.vnfd.df.virtual.link.profile.VirtualLinkProtocolData.class;
    }
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.vnfd.df.virtual.link.profile.virtual.link.protocol.data.L2ProtocolData</code> <code>l2ProtocolData</code>, or <code>null</code> if not present
     */
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.etsi.nfv.yang.etsi.nfv.descriptors.rev190425.vnfd.df.virtual.link.profile.virtual.link.protocol.data.L3ProtocolData</code> <code>l3ProtocolData</code>, or <code>null</code> if not present
     */
