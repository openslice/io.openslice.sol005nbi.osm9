...
public class JujuBuilder implements Builder<Juju> {
    ...
    private org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.juju.Juju _juju;
    ...
    public org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.juju.Juju getJuju() {
        return _juju;
    }
    ...
    public JujuBuilder setJuju(final org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.juju.Juju value) {
        this._juju = value;
        return this;
    }
    ...
    private static final class JujuImpl
        ...
        private final org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.mano.types.rev170208.configuration.method.config.method.juju.Juju _juju;
