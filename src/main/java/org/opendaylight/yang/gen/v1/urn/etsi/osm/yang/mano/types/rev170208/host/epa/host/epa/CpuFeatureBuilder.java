...
/**
 * Class that builds {@link CpuFeatureBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     CpuFeatureBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new CpuFeatureBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of CpuFeatureBuilder, as instances can be freely passed around without
...
public class CpuFeatureBuilder implements Builder<CpuFeature> {
    ...
    public CpuFeatureBuilder(CpuFeature base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<CpuFeature>>, Augmentation<CpuFeature>> aug =((AugmentationHolder<CpuFeature>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public CpuFeatureBuilder addAugmentation(Augmentation<CpuFeature> augmentation) {
    ...
    private CpuFeatureBuilder doAddAugmentation(Class<? extends Augmentation<CpuFeature>> augmentationType, Augmentation<CpuFeature> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class CpuFeatureImpl
        extends AbstractAugmentable<CpuFeature>
        implements CpuFeature {
    
        private final CpuFeatureType _feature;
        private final CpuFeatureKey key;
    
        CpuFeatureImpl(CpuFeatureBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new CpuFeatureKey(base.getFeature());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!CpuFeature.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<CpuFeature>>, Augmentation<CpuFeature>> e : augmentations().entrySet()) {
