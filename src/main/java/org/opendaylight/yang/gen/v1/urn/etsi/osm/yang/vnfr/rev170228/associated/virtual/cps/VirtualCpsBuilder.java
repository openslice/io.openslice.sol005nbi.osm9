...
/**
 * Class that builds {@link VirtualCpsBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VirtualCpsBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VirtualCpsBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VirtualCpsBuilder, as instances can be freely passed around without
...
public class VirtualCpsBuilder implements Builder<VirtualCps> {
    ...
    public VirtualCpsBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.CommonConnectionPoint arg) {
    ...
    public VirtualCpsBuilder(VirtualCps base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<VirtualCps>>, Augmentation<VirtualCps>> aug =((AugmentationHolder<VirtualCps>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    ...
    public VirtualCpsBuilder setPortSecurityDisableStrategy(final PortSecurityDisableStrategy value) {
    ...
    /**
      ...
      */
    public VirtualCpsBuilder addAugmentation(Augmentation<VirtualCps> augmentation) {
    ...
    private VirtualCpsBuilder doAddAugmentation(Class<? extends Augmentation<VirtualCps>> augmentationType, Augmentation<VirtualCps> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VirtualCpsImpl
        extends AbstractAugmentable<VirtualCps>
        implements VirtualCps {
        ...
        VirtualCpsImpl(VirtualCpsBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new VirtualCpsKey(base.getName());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!VirtualCps.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VirtualCps>>, Augmentation<VirtualCps>> e : augmentations().entrySet()) {
