...
/**
 * Class that builds {@link SupplementalBootDataBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     SupplementalBootDataBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new SupplementalBootDataBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of SupplementalBootDataBuilder, as instances can be freely passed around without
...
public class SupplementalBootDataBuilder implements Builder<SupplementalBootData> {
    ...
    /**
      ...
      */
    public SupplementalBootDataBuilder addAugmentation(Augmentation<SupplementalBootData> augmentation) {
    ...
    private SupplementalBootDataBuilder doAddAugmentation(Class<? extends Augmentation<SupplementalBootData>> augmentationType, Augmentation<SupplementalBootData> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class SupplementalBootDataImpl
        extends AbstractAugmentable<SupplementalBootData>
        implements SupplementalBootData {
        ...
        public boolean equals(Object obj) {
            ...
            if (!SupplementalBootData.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<SupplementalBootData>>, Augmentation<SupplementalBootData>> e : augmentations().entrySet()) {
