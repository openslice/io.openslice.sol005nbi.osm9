...
/**
 * Class that builds {@link ExecScaleInOutputBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ExecScaleInOutputBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ExecScaleInOutputBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ExecScaleInOutputBuilder, as instances can be freely passed around without
...
public class ExecScaleInOutputBuilder implements Builder<ExecScaleInOutput> {
    ...
    public ExecScaleInOutputBuilder(ExecScaleInOutput base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<ExecScaleInOutput>>, Augmentation<ExecScaleInOutput>> aug =((AugmentationHolder<ExecScaleInOutput>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public ExecScaleInOutputBuilder setInstanceId(final Uint64 value) {
    ...
    /**
      ...
      */
    public ExecScaleInOutputBuilder addAugmentation(Augmentation<ExecScaleInOutput> augmentation) {
    ...
    private ExecScaleInOutputBuilder doAddAugmentation(Class<? extends Augmentation<ExecScaleInOutput>> augmentationType, Augmentation<ExecScaleInOutput> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ExecScaleInOutputImpl
        extends AbstractAugmentable<ExecScaleInOutput>
        implements ExecScaleInOutput {
    
        private final Uint64 _instanceId;
    
        ExecScaleInOutputImpl(ExecScaleInOutputBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!ExecScaleInOutput.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ExecScaleInOutput>>, Augmentation<ExecScaleInOutput>> e : augmentations().entrySet()) {
