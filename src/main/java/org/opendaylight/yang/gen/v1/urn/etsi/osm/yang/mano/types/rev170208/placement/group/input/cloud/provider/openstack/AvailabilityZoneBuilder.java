...
/**
 * Class that builds {@link AvailabilityZoneBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     AvailabilityZoneBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new AvailabilityZoneBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of AvailabilityZoneBuilder, as instances can be freely passed around without
...
public class AvailabilityZoneBuilder implements Builder<AvailabilityZone> {
    ...
    /**
      ...
      */
    public AvailabilityZoneBuilder addAugmentation(Augmentation<AvailabilityZone> augmentation) {
    ...
    private AvailabilityZoneBuilder doAddAugmentation(Class<? extends Augmentation<AvailabilityZone>> augmentationType, Augmentation<AvailabilityZone> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class AvailabilityZoneImpl
        extends AbstractAugmentable<AvailabilityZone>
        ...
        public boolean equals(Object obj) {
            ...
            if (!AvailabilityZone.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<AvailabilityZone>>, Augmentation<AvailabilityZone>> e : augmentations().entrySet()) {
