...
/**
 * Class that builds {@link VduDependencyBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VduDependencyBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VduDependencyBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VduDependencyBuilder, as instances can be freely passed around without
...
public class VduDependencyBuilder implements Builder<VduDependency> {
    ...
    public VduDependencyBuilder(VduDependency base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<VduDependency>>, Augmentation<VduDependency>> aug =((AugmentationHolder<VduDependency>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    /**
      ...
      */
    public VduDependencyBuilder addAugmentation(Augmentation<VduDependency> augmentation) {
    ...
    private VduDependencyBuilder doAddAugmentation(Class<? extends Augmentation<VduDependency>> augmentationType, Augmentation<VduDependency> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VduDependencyImpl
        extends AbstractAugmentable<VduDependency>
        implements VduDependency {
    
        private final String _vduDependsOnRef;
        private final String _vduSourceRef;
        private final VduDependencyKey key;
    
        VduDependencyImpl(VduDependencyBuilder base) {
            super(base.augmentation);
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new VduDependencyKey(base.getVduSourceRef());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!VduDependency.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VduDependency>>, Augmentation<VduDependency>> e : augmentations().entrySet()) {
