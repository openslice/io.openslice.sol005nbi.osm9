...
/**
 * Class that builds {@link VlrCatalogBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     VlrCatalogBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new VlrCatalogBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of VlrCatalogBuilder, as instances can be freely passed around without
...
public class VlrCatalogBuilder implements Builder<VlrCatalog> {
    ...
    public VlrCatalogBuilder(VlrCatalog base) {
        if (base instanceof AugmentationHolder) {
            ...
            Map<Class<? extends Augmentation<VlrCatalog>>, Augmentation<VlrCatalog>> aug =((AugmentationHolder<VlrCatalog>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    public VlrCatalogBuilder setVlr(final Map<VlrKey, Vlr> values) {
        this._vlr = values;
        return this;
    }
    ...
    /**
      ...
      */
    public VlrCatalogBuilder addAugmentation(Augmentation<VlrCatalog> augmentation) {
    ...
    private VlrCatalogBuilder doAddAugmentation(Class<? extends Augmentation<VlrCatalog>> augmentationType, Augmentation<VlrCatalog> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class VlrCatalogImpl
        extends AbstractAugmentable<VlrCatalog>
        implements VlrCatalog {
    
        private final String _schemaVersion;
        private final Map<VlrKey, Vlr> _vlr;
    
        VlrCatalogImpl(VlrCatalogBuilder base) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!VlrCatalog.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<VlrCatalog>>, Augmentation<VlrCatalog>> e : augmentations().entrySet()) {
