...
public class ConfigPrimitiveKey
 implements Identifier<ConfigPrimitive> {
    ...
    public ConfigPrimitiveKey(String _name) {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof ConfigPrimitiveKey)) {
            return false;
        }
        final ConfigPrimitiveKey other = (ConfigPrimitiveKey) obj;
    ...
    public String toString() {
        final MoreObjects.ToStringHelper helper = MoreObjects.toStringHelper(ConfigPrimitiveKey.class);
