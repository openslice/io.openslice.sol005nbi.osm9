package org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.nsd.rev170228.nsd.constituent.vnfd;
...
/**
 * Class that builds {@link ConstituentVnfdBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     ConstituentVnfdBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new ConstituentVnfdBuilderBuilder()
 ...
 * 
 * <p>
 * This pattern is supported by the immutable nature of ConstituentVnfdBuilder, as instances can be freely passed around without
...
public class ConstituentVnfdBuilder implements Builder<ConstituentVnfd> {
    ...
    /**
      ...
      */
    public ConstituentVnfdBuilder addAugmentation(Augmentation<ConstituentVnfd> augmentation) {
    ...
    private ConstituentVnfdBuilder doAddAugmentation(Class<? extends Augmentation<ConstituentVnfd>> augmentationType, Augmentation<ConstituentVnfd> augmentationValue) {
        if (!(this.augmentation instanceof HashMap)) {
    ...
    private static final class ConstituentVnfdImpl
        extends AbstractAugmentable<ConstituentVnfd>
        implements ConstituentVnfd {
        ...
        public boolean equals(Object obj) {
            ...
            if (!ConstituentVnfd.class.equals(((DataObject)obj).implementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<ConstituentVnfd>>, Augmentation<ConstituentVnfd>> e : augmentations().entrySet()) {
