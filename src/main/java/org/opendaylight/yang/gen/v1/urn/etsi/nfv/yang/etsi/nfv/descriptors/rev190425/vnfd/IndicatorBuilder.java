...
public class IndicatorBuilder implements Builder<Indicator> {
    ...
    private String _id;
    private List<String> _indicatorValue;
    ...
    public IndicatorBuilder setIndicatorValue(final List<String> values) {
        this._indicatorValue = values;
        return this;
    }
    ...
    private static final class IndicatorImpl
        ...
        private final List<String> _indicatorValue;
