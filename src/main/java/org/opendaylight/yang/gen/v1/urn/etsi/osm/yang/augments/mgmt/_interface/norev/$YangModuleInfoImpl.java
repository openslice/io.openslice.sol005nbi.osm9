...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final @NonNull QName NAME = QName.create("urn:etsi:osm:yang:augments:mgmt-interface", "mgmt-interface").intern();
    ...
    protected String resourceName() {
        return "/META-INF/yang/mgmt-interface.yang";
    }
